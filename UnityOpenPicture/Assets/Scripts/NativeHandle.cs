...
//        AndroidJavaObject androidObject = new AndroidJavaObject("com.happykindo.poker.AvatarMainActivity");     
//        m_NativeObj = new AndroidJavaClass("com.unity3d.player.UnityPlayer").GetStatic<AndroidJavaObject>("currentActivity");
...
//        AndroidJavaClass jc = new AndroidJavaClass("com.happykindo.poker.AvatarMainActivity");
//        jc.Call("SettingAvaterFormMobile", strObjectName, strFuncName, strFileName);
//
//        return;
...
//            AndroidJavaObject Test = new AndroidJavaObject("com.happykindo.poker.UserAvatarActivity");
//            Test.Call("SettingAvaterFormMobile", strObjectName, strFuncName, strFileName, ActivityContext);
//
